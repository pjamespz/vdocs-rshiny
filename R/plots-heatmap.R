...
#'
#' @name plot_heatmap
#' @description `plot_heatmap` generates nice heatmaps of a data matrix (or
...
#' @rdname plot_heatmap
#' @export
plot_heatmap <- function(X, y_groups = NULL, x_groups = NULL,
...
#' @rdname plot_heatmap
#' @export
plot_hclust_heatmap <- function(X, y_groups = NULL, x_groups = NULL,
  ...
  plt <- plot_heatmap(X = X, y_groups = y_groups, x_groups = x_groups,
